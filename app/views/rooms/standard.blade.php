  ...
  <div class="row"> 
    ...
    <section class="room-slider standard-slider mt50">
      <div class="col-sm-12 col-md-8">
        <div id="owl-standard" class="owl-carousel">
          <div class="item"> <a href="{{asset('assets/images/rooms/standard/room-1.JPG')}}" data-rel="prettyPhoto[gallery1]"><img src="{{asset('assets/images/rooms/standard/room-1.JPG')}}" alt="Bed" class="img-responsive"></a> </div>
          <div class="item"> <a href="{{asset('assets/images/rooms/standard/room-2.JPG')}}" data-rel="prettyPhoto[gallery1]"><img src="{{asset('assets/images/rooms/standard/room-2.JPG')}}" alt="Bathroom" class="img-responsive"></a> </div>
        </div>
      </div>
    </section>
    ...
    <section id="reservation-form" class="mt50 clearfix">
      <div class="col-sm-12 col-md-4">
        <form class="reservation-vertical clearfix" role="form" method="post"  name="reservationform" id="bookingform" onsubmit="create_booking('bookingform','{{URL::to('addbooking')}}');event.preventDefault();">
          <h2 class="lined-heading"><span>Reservation</span></h2>
          <div class="price">
            <h4>Nordic Standard Room</h4>
          &#8358; 18,500,-<span> a night</span></div>
          <div id="message"></div>
          ...
          <div class="form-group">
            <select class="hidden" name="room" id="room" disabled="disabled">
                 <option value="Single">The Nordic Standard Room</option>
            ...
            <table class="table table-striped mt30">
              <tbody>
                <tr>
                  ...
                  <td><i class="fa fa-check-circle"></i>  Working Desk</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td><i class="fa fa-check-circle"></i> Room Size (444m x 354m) </td>
