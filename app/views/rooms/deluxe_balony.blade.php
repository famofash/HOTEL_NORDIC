    ...
    <section class="room-slider standard-slider mt50">
      <div class="col-sm-12 col-md-8">
         <div id="owl-standard" class="owl-carousel">
          <div class="item"> <a href="{{asset('assets/images/rooms/deluxe_balcony/room-1.JPG')}}" data-rel="prettyPhoto[gallery1]"><img src="{{asset('assets/images/rooms/deluxe_balcony/room-1.JPG')}}" alt="Bed" class="img-responsive"></a> </div>
          <div class="item"> <a href="{{asset('assets/images/rooms/deluxe_balcony/room-2.JPG')}}" data-rel="prettyPhoto[gallery1]"><img src="{{asset('assets/images/rooms/deluxe_balcony/room-2.JPG')}}" alt="Bathroom" class="img-responsive"></a> </div>
           <div class="item"> <a href="{{asset('assets/images/rooms/deluxe_balcony/room-3.JPG')}}" data-rel="prettyPhoto[gallery1]"><img src="{{asset('assets/images/rooms/deluxe_balcony/room-3.JPG')}}" alt="Bathroom" class="img-responsive"></a> </div>
        <div class="item"> <a href="{{asset('assets/images/rooms/deluxe_balcony/room-5.JPG')}}" data-rel="prettyPhoto[gallery1]"><img src="{{asset('assets/images/rooms/deluxe_balcony/room-5.JPG')}}" alt="Bathroom" class="img-responsive"></a> </div>
          <div class="item"> <a href="{{asset('assets/images/rooms/deluxe_balcony/room-6.JPG')}}" data-rel="prettyPhoto[gallery1]"><img src="{{asset('assets/images/rooms/deluxe_balcony/room-6.JPG')}}" alt="Bathroom" class="img-responsive"></a> </div>
        <div class="item"> <a href="{{asset('assets/images/rooms/deluxe_balcony/room-7.JPG')}}" data-rel="prettyPhoto[gallery1]"><img src="{{asset('assets/images/rooms/deluxe_balcony/room-7.JPG')}}" alt="Bathroom" class="img-responsive"></a> </div>
        </div>
      </div>
    </section>
    ...
    <section id="reservation-form" class="mt50 clearfix">
      <div class="col-sm-12 col-md-4">
        <form class="reservation-vertical clearfix" role="form" method="post" onsubmit="create_booking('reservationform','{{URL::to('addbooking')}}');event.preventDefault();" id="reservationform">
          ...
          <div class="price">
            <h4>The Nordic Deluxe Balcony - </h4>
           &#8358; 29,500,<span> a night</span></div>
          <div id="message"></div>
          ...
          <div class="form-group">
            <select class="hidden" name="room" id="room" disabled="disabled">
                 <option value="Single">The Nordic Deluxe Balcony</option>
              ...
              <tbody>
                <tr>
                  ...
                  <td><i class="fa fa-check-circle"></i> Free Internet</td>
                     <td><i class="fa fa-check-circle"></i> Room Size (530m x 410m) </td>
                </tr>
                <tr>
