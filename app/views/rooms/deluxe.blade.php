  ...
  <div class="row"> 
    ...
    <section class="room-slider standard-slider mt50">
      <div class="col-sm-12 col-md-8">
          ...
          <div class="item"> <a href="{{asset('assets/images/rooms/deluxe/room-1.JPG')}}" data-rel="prettyPhoto[gallery1]"><img src="{{asset('assets/images/rooms/deluxe/room-1.JPG')}}" alt="Bed" class="img-responsive"></a> </div>
          <div class="item"> <a href="{{asset('assets/images/rooms/deluxe/room-2.JPG')}}" data-rel="prettyPhoto[gallery1]"><img src="{{asset('assets/images/rooms/deluxe/room-2.JPG')}}" alt="Bathroom" class="img-responsive"></a> </div>
           <div class="item"> <a href="{{asset('assets/images/rooms/deluxe/room-3.JPG')}}" data-rel="prettyPhoto[gallery1]"><img src="{{asset('assets/images/rooms/deluxe/room-3.JPG')}}" alt="Bathroom" class="img-responsive"></a> </div>
          <div class="item"> <a href="{{asset('assets/images/rooms/deluxe/room-4.JPG')}}" data-rel="prettyPhoto[gallery1]"><img src="{{asset('assets/images/rooms/deluxe/room-4.JPG')}}" alt="Bathroom" class="img-responsive"></a> </div>
          <div class="item"> <a href="{{asset('assets/images/rooms/deluxe/room-5.JPG')}}" data-rel="prettyPhoto[gallery1]"><img src="{{asset('assets/images/rooms/deluxe/room-5.JPG')}}" alt="Bathroom" class="img-responsive"></a> </div>
          <div class="item"> <a href="{{asset('assets/images/rooms/deluxe/room-6.JPG')}}" data-rel="prettyPhoto[gallery1]"><img src="{{asset('assets/images/rooms/deluxe/room-6.JPG')}}" alt="Bathroom" class="img-responsive"></a> </div>
        ...
        <form class="reservation-vertical clearfix" role="form" method="post" onsubmit="create_booking('reservationform','{{URL::to('addbooking')}}');event.preventDefault();" id="reservationform">
          ...
          <div class="form-group">
            <select class="hidden" name="room" id="room" disabled="disabled">
                 <option value="Single">The Nordic Deluxe Suite</option>
              ...
              <tbody>
                <tr>
                  ...
                  <td><i class="fa fa-check-circle"></i> Free Internet</td>
                   <td><i class="fa fa-check-circle"></i> Room Size (615m x 576m) </td>
                </tr>
                <tr>
