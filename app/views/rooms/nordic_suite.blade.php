  ...
  <div class="row"> 
    ...
    <section class="room-slider standard-slider mt50">
      <div class="col-sm-12 col-md-8">
        <div id="owl-standard" class="owl-carousel">
          <div class="item"> <a href="{{asset('assets/images/rooms/nordic_suite/room-1.JPG')}}" data-rel="prettyPhoto[gallery1]"><img src="{{asset('assets/images/rooms/nordic_suite/room-1.JPG')}}" alt="Bed" class="img-responsive"></a> </div>
          <div class="item"> <a href="{{asset('assets/images/rooms/nordic_suite/room-2.JPG')}}" data-rel="prettyPhoto[gallery1]"><img src="{{asset('assets/images/rooms/nordic_suite/room-2.JPG')}}" alt="Bathroom" class="img-responsive"></a> </div>
           <div class="item"> <a href="{{asset('assets/images/rooms/nordic_suite/room-3.JPG')}}" data-rel="prettyPhoto[gallery1]"><img src="{{asset('assets/images/rooms/nordic_suite/room-3.JPG')}}" alt="Bathroom" class="img-responsive"></a> </div>
          <div class="item"> <a href="{{asset('assets/images/rooms/nordic_suite/room-4.JPG')}}" data-rel="prettyPhoto[gallery1]"><img src="{{asset('assets/images/rooms/nordic_suite/room-4.JPG')}}" alt="Bathroom" class="img-responsive"></a> </div>
          <div class="item"> <a href="{{asset('assets/images/rooms/nordic_suite/room-5.JPG')}}" data-rel="prettyPhoto[gallery1]"><img src="{{asset('assets/images/rooms/nordic_suite/room-5.JPG')}}" alt="Bathroom" class="img-responsive"></a> </div>
          <div class="item"> <a href="{{asset('assets/images/rooms/nordic_suite/room-6.JPG')}}" data-rel="prettyPhoto[gallery1]"><img src="{{asset('assets/images/rooms/nordic_suite/room-6.JPG')}}" alt="Bathroom" class="img-responsive"></a> </div>
    ...
    <section id="reservation-form" class="mt50 clearfix">
      <div class="col-sm-12 col-md-4">
        <form class="reservation-vertical clearfix" role="form" method="post" id="bookingform" onsubmit="create_booking('bookingform','{{URL::to('addbooking')}}');event.preventDefault();">
          <h2 class="lined-heading"><span>Reservation</span></h2>
          <div class="price">
            <h4>The Nordic Suite</h4>
            &#8358; 35,500,-<span> a night</span></div>
          <div id="message"></div>
          ...
          <div class="form-group">
            <select class="hidden" name="room" id="room" disabled="disabled">
                 <option value="Single">The Nordic Suite</option>
          ...
          <div class="form-group">
            ...
            <input name="chec-kin" type="text" id="checkin" value="" class="form-control" placeholder="Check-in"/>
          </div>
          <div class="form-group">
            ...
            <table class="table table-striped mt30">
              <tbody>
                <tr>
                  ...
                  <td><i class="fa fa-check-circle"></i> Room Size (770m x 530m)</td>
                </tr>
                <tr>
                  <td></td>
